# Galaxyxmusic (Telegram bot project )
...
def song(client, message):
    ...
    for i in message.command[1:]:
        query += ' ' + str(i)
    print(query)
    m = message.reply('𝙎𝙚𝙖𝙧𝙘𝙝𝙞𝙣𝙜 𝙏𝙝𝙚 𝙎𝙤𝙣𝙜 ••• 🔎')
    ...
    try:
        ...
        m.edit(
            "𝙁𝙤𝙪𝙣𝙙 𝙉𝙤𝙩𝙝𝙞𝙣𝙜 😕 \n\n𝙏𝙧𝙮 𝙖𝙣𝙤𝙩𝙝𝙚𝙧 𝙠𝙚𝙮𝙬𝙤𝙧𝙙 𝙤𝙧 𝙢𝙖𝙮𝙗𝙚 𝙨𝙥𝙚𝙡𝙡 𝙞𝙩 𝙥𝙧𝙤𝙥𝙚𝙧𝙡𝙮..."
        )
        print(str(e))
        return
...
async def jssong(_, message):
    ...
    if len(message.command) < 2:
        await message.reply_text("/saavn 𝙧𝙚𝙦𝙪𝙞𝙧𝙚𝙨 𝙖𝙣 𝙖𝙧𝙜𝙪𝙢𝙚𝙣𝙩.")
        return
    if is_downloading:
        await message.reply_text("𝘼𝙣𝙤𝙩𝙝𝙚𝙧 𝙙𝙤𝙬𝙣𝙡𝙤𝙖𝙙 𝙞𝙨 𝙞𝙣 𝙥𝙧𝙤𝙜𝙧𝙚𝙨𝙨, 𝙩𝙧𝙮 𝙖𝙜𝙖𝙞𝙣 𝙖𝙛𝙩𝙚𝙧 𝙨𝙤𝙢𝙚𝙩𝙞𝙢𝙚. 😉")
        return
    is_downloading = True
...
async def deezsong(_, message):
    global is_downloading
    if len(message.command) < 2:
        await message.reply_text("/deezer 𝙧𝙚𝙦𝙪𝙞𝙧𝙚𝙨 𝙖𝙣 𝙖𝙧𝙜𝙪𝙢𝙚𝙣𝙩.")
        return
    if is_downloading:
        await message.reply_text("𝘼𝙣𝙤𝙩𝙝𝙚𝙧 𝙙𝙤𝙬𝙣𝙡𝙤𝙖𝙙 𝙞𝙨 𝙞𝙣 𝙥𝙧𝙤𝙜𝙧𝙚𝙨𝙨, 𝙩𝙧𝙮 𝙖𝙜𝙖𝙞𝙣 𝙖𝙛𝙩𝙚𝙧 𝙨𝙤𝙢𝙚𝙩𝙞𝙢𝙚. 😉")
        return
...
async def ytmusic(client,message: Message):
    ...
    if not urlissed:
        await pablo.edit("𝙄𝙣𝙫𝙖𝙡𝙞𝙙 𝘾𝙤𝙢𝙢𝙖𝙣𝙙 𝙎𝙮𝙣𝙩𝙖𝙭, 𝙋𝙡𝙚𝙖𝙨𝙚 𝘾𝙝𝙚𝙘𝙠 𝙃𝙚𝙡𝙥 𝙈𝙚𝙣𝙪 𝙏𝙤 𝙆𝙣𝙤𝙬 𝙈𝙤𝙧𝙚 !")
        return
    ...
    try:
        ...
        with youtube_dl.YoutubeDL(opts) as ytdl:
            ...
            if duration > 999:
                await pablo.edit(
                    f"𝙑𝙞𝙙𝙚𝙤𝙨 𝙡𝙤𝙣𝙜𝙚𝙧 𝙩𝙝𝙖𝙣 999 𝙢𝙞𝙣𝙪𝙩𝙚(𝙨) 𝙖𝙧𝙚𝙣'𝙩 𝙖𝙡𝙡𝙤𝙬𝙚𝙙, 𝙩𝙝𝙚 𝙥𝙧𝙤𝙫𝙞𝙙𝙚𝙙 𝙫𝙞𝙙𝙚𝙤 𝙞𝙨 {duration} 𝙢𝙞𝙣𝙪𝙩𝙚(𝙨) ❌"
                )
                is_downloading = False
                return
        ...
        await pablo.edit(event, f"**𝙁𝙖𝙞𝙡𝙚𝙙 𝙏𝙤 𝘿𝙤𝙬𝙣𝙡𝙤𝙖𝙙 😕** \nError : `{str(e)}`")
        is_downloading = False
        return
