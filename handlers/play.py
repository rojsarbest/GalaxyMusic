...
async def playlist(client, message):
    ...
    if not queue:
        await message.reply_text('𝙋𝙡𝙖𝙮𝙚𝙧 𝙞𝙨 𝙞𝙙𝙡𝙚')
    temp = []
    for t in queue:
        temp.append(t)
    now_playing = temp[0][0]
    by = temp[0][1].mention(style='md')
    msg = "**𝙉𝙤𝙬 𝙋𝙡𝙖𝙮𝙞𝙣𝙜 •••** in {}".format(message.chat.title)
    msg += "\n- "+ now_playing
    msg += "\n- Req by "+by
    temp.pop(0)
    if temp:
...
async def p_cb(b, cb):
    ...
    if type_ == 'playlist':           
        ...
        if not queue:   
            await cb.message.edit('𝙋𝙡𝙖𝙮𝙚𝙧 𝙞𝙨 𝙞𝙙𝙡𝙚')
        temp = []
        for t in queue:
            temp.append(t)
        now_playing = temp[0][0]
        by = temp[0][1].mention(style='md')
        msg = "**𝙉𝙤𝙬 𝙋𝙡𝙖𝙮𝙞𝙣𝙜 •••** in {}".format(cb.message.chat.title)
        msg += "\n- "+ now_playing
        msg += "\n- Req by "+by
        temp.pop(0)
        if temp:
...
async def m_cb(b, cb):
    ...
    if type_ == 'pause':
        if (
            ...
            await cb.answer('𝘾𝙝𝙖𝙩 𝙞𝙨 𝙣𝙤𝙩 𝙘𝙤𝙣𝙣𝙚𝙘𝙩𝙚𝙙!', show_alert=True)
        else:
            callsmusic.pytgcalls.pause_stream(chat_id)
            
            await cb.answer('𝙈𝙪𝙨𝙞𝙘 𝙋𝙖𝙪𝙨𝙚𝙙!')
        ...
        if (
            ...
            await cb.answer('𝘾𝙝𝙖𝙩 𝙞𝙨 𝙣𝙤𝙩 𝙘𝙤𝙣𝙣𝙚𝙘𝙩𝙚𝙙 𝙤𝙧 𝙖𝙡𝙧𝙚𝙖𝙙𝙮 𝙥𝙖𝙪𝙨𝙚𝙙', show_alert=True)
        else:
            callsmusic.pytgcalls.pause_stream(chat_id)
        ...
        if chat_id not in callsmusic.pytgcalls.active_calls:
            ...
            if callsmusic.queues.is_empty(chat_id):
                ...
                await cb.message.edit('- 𝙉𝙤 𝙈𝙤𝙧𝙚 𝙋𝙡𝙖𝙮𝙡𝙞𝙨𝙩..\n- 𝙇𝙚𝙖𝙫𝙞𝙣𝙜 𝙑oice 𝘾hat!')
            else:
                ...
                await cb.message.reply_text(f'- 𝙎𝙠𝙞𝙥𝙥𝙚𝙙 𝙩𝙧𝙖𝙘𝙠\n- 𝙉𝙤𝙬 𝙋𝙡𝙖𝙮𝙞𝙣𝙜 ••• **{qeue[0][0]}**')
        ...
        if chat_id in callsmusic.pytgcalls.active_calls:
            ...
            callsmusic.pytgcalls.leave_group_call(chat_id)
            await cb.message.edit('𝙎𝙪𝙘𝙘𝙚𝙨𝙨𝙛𝙪𝙡𝙡𝙮 𝙇𝙚𝙛𝙩 𝙩𝙝𝙚 𝘾𝙝𝙖𝙩!')
        else:
            await cb.answer('𝘾𝙝𝙖𝙩 𝙞𝙨 𝙣𝙤𝙩 𝙘𝙤𝙣𝙣𝙚𝙘𝙩𝙚𝙙!', show_alert=True)
...
async def play(_, message: Message):
    ...
    for administrator in administrators:
       if administrator == message.from_user.id:  
               try:
                   ...
                   await lel.edit(
                       "<b>𝘼𝙙𝙙 𝙢𝙚 𝙖𝙨 𝙖𝙙𝙢𝙞𝙣 𝙤𝙛 𝙮𝙤𝙧 𝙜𝙧𝙤𝙪𝙥 𝙛𝙞𝙧𝙨𝙩</b>",
                   )
                   return
    ...
    if message.chat.id in callsmusic.pytgcalls.active_calls:
        ...
        photo="final.png", 
        caption=f"📝 𝙔𝙤𝙪𝙧 𝙧𝙚𝙦𝙪𝙚𝙨𝙩𝙚𝙙 𝙨𝙤𝙣𝙜 ••• **queued** 𝙖𝙩 𝙥𝙤𝙨𝙞𝙩𝙞𝙤𝙣 {position}!",
...
async def deezer(client: Client, message_: Message):
    ...
    queryy = text[1]
    res = lel
    await res.edit(f"𝙎𝙚𝙖𝙧𝙘𝙝𝙞𝙣𝙜 ••• 🔍 for `{queryy}` on deezer")
    try:
...
async def jiosaavn(client: Client, message_: Message):
    ...
    query = text[1]
    res = lel
    await res.edit(f"𝙎𝙚𝙖𝙧𝙘𝙝𝙞𝙣𝙜 🔍 𝙛𝙤𝙧 `{query}` 𝙤𝙣 𝙟𝙞𝙤 𝙨𝙖𝙖𝙫𝙣")
    try:
        async with aiohttp.ClientSession() as session:
        ...
        await res.edit(
            "𝙁𝙤𝙪𝙣𝙙 𝙇𝙞𝙩𝙚𝙧𝙖𝙡𝙡𝙮 𝙉𝙤𝙩𝙝𝙞𝙣𝙜!, 𝙔𝙤𝙪 𝙎𝙝𝙤𝙪𝙡𝙙 𝙒𝙤𝙧𝙠 𝙊𝙣 𝙔𝙤𝙪𝙧 𝙀𝙣𝙜𝙡𝙞𝙨𝙝."
        )
        print(str(e))
        is_playing = False
        return
    ...
    if message_.chat.id in callsmusic.pytgcalls.active_calls:
        ...
        qeue.append(appendable)
        callsmusic.pytgcalls.join_group_call(message_.chat.id, file_path)
    await res.edit("𝙂𝙚𝙣𝙚𝙧𝙖𝙩𝙞𝙣𝙜 𝙏𝙝𝙪𝙢𝙗𝙣𝙖𝙞𝙡 🚀")
    ...
    m = await client.send_photo(
        ...
        reply_markup=keyboard,
        photo="final.png",
        caption=f"𝙋𝙡𝙖𝙮𝙞𝙣𝙜 ••• {sname} 𝙑𝙞𝙖 𝙅𝙞𝙤𝙨𝙖𝙖𝙫𝙣",
